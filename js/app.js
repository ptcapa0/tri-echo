...
import {calibrateShot,computeGestureMetrics,crossedPowerThreshold,estimateStoppingDistance} from './physics-calibration.js';
...
function aimPreview(){const pull=floatingPull(),cue=game?.table.balls[0];if(!game||!cue)return null;const profile=AIM_PROFILES[game.difficulty]||AIM_PROFILES.normal;return deriveAimPreview({table:game.table,cueBall:cue,shotDirection:pull.shotDirection,shotSpeed:pull.speed,assistance:profile.assistance,maxPhysicalTravel:estimateStoppingDistance(pull.speed,{traditional:game.table.traditional}),trace:game.activePower==='trace'})}
