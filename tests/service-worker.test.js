...
test('service worker deletes only obsolete TRI//ECHO caches',async()=>{
 const handlers={},deleted=[],keys=['tri-echo-v4.2.1','tri-echo-v4.3.0','tri-echo-v4.3.1','outro-jogo-v1','qualquer-cache-X'];
 ...
 await activation;
 assert.deepEqual(deleted,['tri-echo-v4.2.1','tri-echo-v4.3.0']);
