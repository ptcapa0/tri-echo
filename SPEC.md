...
- Controlos: Floating Pull pode começar em qualquer ponto jogável do canvas, incluindo sobre a branca; o gesto é inverso à tacada e a distância em píxeis CSS determina a força, sem depender da posição da branca. O controlo circular móvel define seguimento, recuo e efeito lateral.
